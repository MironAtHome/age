                                    ...
                                    char *rhs, int rlen)
{
    ...
    buffer = palloc0(length);

    strncpy_s(buffer, length, lhs, llen);
    strncpy_s(buffer + llen, length, rhs, rlen);
...
static char *get_string_from_agtype_value(agtype_value *agtv, int *length)
{
    ...
    case AGTV_FLOAT:
        ...
        *length = strlen(string);
        ...
        {
            char *str = palloc0(*length + 2);
            strncpy_s(str, (*length + 2), string, *length);
            strncpy_s(str + *length, (*length + 2), ".0", 2);
            *length += 2;
            string = str;
        }
        return string;
...
PGMODULEEXPORT Datum agtype_add(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum agtype_any_add(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_sub(PG_FUNCTION_ARGS)
{
    agtype *lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *rhs = AG_GET_ARG_AGTYPE_P(1);
    agtype_value *agtv_lhs;
...
PGMODULEEXPORT Datum agtype_any_sub(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_neg(PG_FUNCTION_ARGS)
{
 ...
 */
PGMODULEEXPORT Datum agtype_mul(PG_FUNCTION_ARGS)
{
    agtype *lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *rhs = AG_GET_ARG_AGTYPE_P(1);
    agtype_value *agtv_lhs;
...
PGMODULEEXPORT Datum agtype_any_mul(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_div(PG_FUNCTION_ARGS)
{
    agtype *lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *rhs = AG_GET_ARG_AGTYPE_P(1);
    agtype_value *agtv_lhs;
...
PGMODULEEXPORT Datum agtype_any_div(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_mod(PG_FUNCTION_ARGS)
{
    agtype *lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *rhs = AG_GET_ARG_AGTYPE_P(1);
    agtype_value *agtv_lhs;
...
PGMODULEEXPORT Datum agtype_any_mod(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_pow(PG_FUNCTION_ARGS)
{
    agtype *lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *rhs = AG_GET_ARG_AGTYPE_P(1);
    agtype_value *agtv_lhs;
...
PGMODULEEXPORT Datum agtype_eq(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum agtype_any_eq(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
...
PGMODULEEXPORT Datum agtype_ne(PG_FUNCTION_ARGS)
{
    Datum lhs = PG_GETARG_DATUM(0);
    Datum rhs = PG_GETARG_DATUM(1);
    uint32 hash_lhs = datum_image_hash(lhs, false, -1);
...
PGMODULEEXPORT Datum agtype_any_ne(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
...
PGMODULEEXPORT Datum agtype_lt(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum agtype_any_lt(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
...
PGMODULEEXPORT Datum agtype_gt(PG_FUNCTION_ARGS)
{
    agtype *agtype_lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *agtype_rhs = AG_GET_ARG_AGTYPE_P(1);
    bool result;
...
PGMODULEEXPORT Datum agtype_any_gt(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
...
PGMODULEEXPORT Datum agtype_le(PG_FUNCTION_ARGS)
{
    agtype *agtype_lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *agtype_rhs = AG_GET_ARG_AGTYPE_P(1);
    bool result;
...
PGMODULEEXPORT Datum agtype_any_le(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
...
PGMODULEEXPORT Datum agtype_ge(PG_FUNCTION_ARGS)
{
    agtype *agtype_lhs = AG_GET_ARG_AGTYPE_P(0);
    agtype *agtype_rhs = AG_GET_ARG_AGTYPE_P(1);
    bool result;
...
PGMODULEEXPORT Datum agtype_any_ge(PG_FUNCTION_ARGS)
{
    agtype *lhs;
    agtype *rhs;
    Datum result;
 ...
 */
PGMODULEEXPORT Datum agtype_exists_agtype(PG_FUNCTION_ARGS)
{
 ...
 * top-level keys
 */
PGMODULEEXPORT Datum agtype_exists_any_agtype(PG_FUNCTION_ARGS)
{
    agtype *agt = AG_GET_ARG_AGTYPE_P(0);
 ...
 * top-level keys
 */
PGMODULEEXPORT Datum agtype_exists_all_agtype(PG_FUNCTION_ARGS)
{
    agtype *agt = AG_GET_ARG_AGTYPE_P(0);
    agtype *keys = AG_GET_ARG_AGTYPE_P(1);
    agtype_value elem;
 ...
 */
PGMODULEEXPORT Datum agtype_contains(PG_FUNCTION_ARGS)
{
 ...
 */
PGMODULEEXPORT Datum agtype_contained_by_top_level(PG_FUNCTION_ARGS)
{
 ...
 */
PGMODULEEXPORT Datum agtype_contained_by(PG_FUNCTION_ARGS)
{
    agtype_iterator *constraint_it, *property_it;
    agtype *properties, *constraints;
 ...
 */
PGMODULEEXPORT Datum agtype_contains_top_level(PG_FUNCTION_ARGS)
{
    agtype_iterator *constraint_it = NULL;
    agtype_iterator *property_it = NULL;
    agtype *properties = NULL;
 ...
 * ? operator for agtype. Returns true if the string exists as top-level keys
 */
PGMODULEEXPORT Datum agtype_exists(PG_FUNCTION_ARGS)
{
    agtype *agt = AG_GET_ARG_AGTYPE_P(0);
 ...
 * top-level keys
 */
PGMODULEEXPORT Datum agtype_exists_any(PG_FUNCTION_ARGS)
{
    agtype *agt = AG_GET_ARG_AGTYPE_P(0);
 ...
 * top-level keys
 */
PGMODULEEXPORT Datum agtype_exists_all(PG_FUNCTION_ARGS)
{
    agtype *agt = AG_GET_ARG_AGTYPE_P(0);
    ArrayType  *keys = PG_GETARG_ARRAYTYPE_P(1);
    int i;
...
PGMODULEEXPORT Datum agtype_concat(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum agtype_extract_path(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum agtype_extract_path_text(PG_FUNCTION_ARGS)
{
